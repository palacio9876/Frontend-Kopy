              ...
              <>
                <div className="row-product ">
                  {allProducts.map((article) => (
                    <div
                      className="cart-product flex align-center justify-center"
                      key={article.id_producto}
                    >
                      <div className="info-cart-product">
                        <div className="flex flex-col h-5 mt-[-25px]">
                          ...
                          >
                            <p className="text-green-500 text-2xl m-20px  mb-[-5px]">
                              +
                            </p>
                          </button>
                          <span className="cantidad-producto-carrito">
                            {article.cantidad_producto}
                          </span>
                          ...
                          >
                            <p className="text-red-500 text-2xl  mt-[-10px] ">
                              -
                            </p>
                          </button>
                        </div>
                ...
                <NavLink
                  to="/buys"
                  className=" text-center text-white block w-full  cursor-pointer text-base transition-all duration-[0.3s] ease-[ease] px-0 py-[15px] border-[none] bg-green-600"
                  onClick={onCash}
                >
                  Comprar
                </NavLink>
                ...
                <button
                  className=" text-white block w-full cursor-pointer text-base transition-all duration-[0.3s] ease-[ease]  px-0 py-[15px] rounded-br-[10px] rounded-bl-[10px] border-[none] bg-red-600"
                  onClick={onCleanCart}
                >
                  Vaciar Carrito
                </button>
